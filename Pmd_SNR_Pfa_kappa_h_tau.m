...
set(0,'defaultfigurecolor','w');
 ...
 plot(SNR_dB,Pfa_theoretical(3,:),'-*k','LineWidth',2,'MarkerSize',10);
...
xlabel('SNR per hop (dB)','fontsize',24);
ylabel('P_{md}/P_{fa}','fontsize',24);
set(gca,'XTick',SNR_dB(1):2:SNR_dB(end),'YTick',0:0.1:1,'FontSize',24,...
   'FontName','Times New Roman');
legend('\kappa_h=-5dB (P_{md})','\kappa_h=0dB (P_{md})','\kappa_h=5dB (P_{md})','\kappa_h=-5dB (P_{fa})','\kappa_h=0dB (P_{fa})','\kappa_h=5dB (P_{fa})','Simulation');
grid on
